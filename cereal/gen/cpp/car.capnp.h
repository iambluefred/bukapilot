...
public:
  ...
  inline bool getFrontDeparture() const;
...
public:
  ...
  inline bool getFrontDeparture();
  inline void setFrontDeparture(bool value);
...
inline bool CarState::Reader::getFrontDeparture() const {
  return _reader.getDataField<bool>(
      ::capnp::bounded<356>() * ::capnp::ELEMENTS);
}

inline bool CarState::Builder::getFrontDeparture() {
  return _builder.getDataField<bool>(
      ::capnp::bounded<356>() * ::capnp::ELEMENTS);
}
inline void CarState::Builder::setFrontDeparture(bool value) {
  _builder.setDataField<bool>(
