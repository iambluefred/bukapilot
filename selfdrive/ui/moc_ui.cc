...
QT_MOC_LITERAL(9, 63, 12), // "setKeepAwake"
QT_MOC_LITERAL(10, 76, 4) // "keep"

    },
    "Device\0displayPowerChanged\0\0on\0setAwake\0"
    "reset\0update\0UIState\0s\0setKeepAwake\0"
    "keep"
};
#undef QT_MOC_LITERAL
...
void Device::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->setKeepAwake((*reinterpret_cast< bool(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
