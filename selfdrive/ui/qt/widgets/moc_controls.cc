...
struct qt_meta_stringdata_SpinboxControl_t {
    QByteArrayData data[8];
    char stringdata0[94];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_SpinboxControl_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_SpinboxControl_t qt_meta_stringdata_SpinboxControl = {
    {
QT_MOC_LITERAL(0, 0, 14), // "SpinboxControl"
QT_MOC_LITERAL(1, 15, 16), // "deselectTextEdit"
QT_MOC_LITERAL(2, 32, 0), // ""
QT_MOC_LITERAL(3, 33, 19), // "alertRebootRequired"
QT_MOC_LITERAL(4, 53, 9), // "setParams"
QT_MOC_LITERAL(5, 63, 11), // "param_value"
QT_MOC_LITERAL(6, 75, 10), // "setEnabled"
QT_MOC_LITERAL(7, 86, 7) // "enabled"

    },
    "SpinboxControl\0deselectTextEdit\0\0"
    "alertRebootRequired\0setParams\0param_value\0"
    "setEnabled\0enabled"
};
#undef QT_MOC_LITERAL

static const uint qt_meta_data_SpinboxControl[] = {
...
void SpinboxControl::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<SpinboxControl *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->deselectTextEdit(); break;
        case 1: _t->alertRebootRequired(); break;
        case 2: _t->setParams((*reinterpret_cast< double(*)>(_a[1]))); break;
...
QT_INIT_METAOBJECT const QMetaObject SpinboxControl::staticMetaObject = { {
    &AbstractControl::staticMetaObject,
    qt_meta_stringdata_SpinboxControl.data,
    qt_meta_data_SpinboxControl,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
const QMetaObject *SpinboxControl::metaObject() const
{
    return QObject::d_ptr->metaObject ? QObject::d_ptr->dynamicMetaObject() : &staticMetaObject;
}

void *SpinboxControl::qt_metacast(const char *_clname)
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_SpinboxControl.stringdata0))
        return static_cast<void*>(this);
    return AbstractControl::qt_metacast(_clname);
}

int SpinboxControl::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = AbstractControl::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
