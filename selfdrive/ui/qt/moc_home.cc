...
QT_MOC_LITERAL(1, 12, 12), // "setAlertIcon"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 9), // "hasUnread"
QT_MOC_LITERAL(4, 36, 10), // "openAlerts"
QT_MOC_LITERAL(5, 47, 11) // "closeAlerts"

    },
    "OffroadHome\0setAlertIcon\0\0hasUnread\0"
    "openAlerts\0closeAlerts"
};
#undef QT_MOC_LITERAL
...
void OffroadHome::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->setAlertIcon((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 1: _t->openAlerts(); break;
        case 2: _t->closeAlerts(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (OffroadHome::*)(bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&OffroadHome::setAlertIcon)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void OffroadHome::setAlertIcon(bool _t1)
{
