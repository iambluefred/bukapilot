...
struct qt_meta_stringdata_OnroadAddons_t {
    QByteArrayData data[3];
    char stringdata0[27];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_OnroadAddons_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_OnroadAddons_t qt_meta_stringdata_OnroadAddons = {
    {
QT_MOC_LITERAL(0, 0, 12), // "OnroadAddons"
QT_MOC_LITERAL(1, 13, 12), // "openSettings"
QT_MOC_LITERAL(2, 26, 0) // ""

    },
    "OnroadAddons\0openSettings\0"
};
#undef QT_MOC_LITERAL

static const uint qt_meta_data_OnroadAddons[] = {
...
void OnroadAddons::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<OnroadAddons *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (OnroadAddons::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&OnroadAddons::openSettings)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject OnroadAddons::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_OnroadAddons.data,
    qt_meta_data_OnroadAddons,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
const QMetaObject *OnroadAddons::metaObject() const
{
    return QObject::d_ptr->metaObject ? QObject::d_ptr->dynamicMetaObject() : &staticMetaObject;
}

void *OnroadAddons::qt_metacast(const char *_clname)
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_OnroadAddons.stringdata0))
        return static_cast<void*>(this);
    return QWidget::qt_metacast(_clname);
}

int OnroadAddons::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = QWidget::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
...
// SIGNAL 0
void OnroadAddons::openSettings()
{
...
QT_MOC_LITERAL(8, 76, 17) // "offroadTransition"

    },
    "OnroadWindow\0update\0\0UIState\0s\0"
    "offroadTransitionSignal\0offroad\0"
    "openSettings\0offroadTransition"
};
#undef QT_MOC_LITERAL
