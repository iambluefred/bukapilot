...
segments = [
  ("PERODUA", "ef1515efcccceded---2021-12-21--02-08-29--2---rlog.bz2"),
...
excluded_interfaces = ["mock", "ford", "mazda", "tesla", "honda", "volkswagen", "gm", "nissan", "subaru", "toyota", "chrysler", "hyundai", "proton"]

BASE_URL = "https://s4.kommu.ai/upload/regression_test/"
