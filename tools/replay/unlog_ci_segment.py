...
#INTERESTED = ['pandaStates','can']
INTERESTED = ['peripheralState','modelV2','sensorEvents','driverMonitoringState','driverCameraState','pandaStates','can','roadCameraState','roadEncodeIdx']
